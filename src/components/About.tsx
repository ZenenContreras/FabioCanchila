...
import { BookOpen, Youtube, Target, Users, Briefcase, LineChart, Building2, HandshakeIcon, Brain, Rocket, Trophy, Star } from 'lucide-react';
...
export default function About() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      {/* Hero Section */}
      <section className="relative py-16 bg-gradient-to-b from-primary/10 to-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                gestión estratégica y liderazgo de programas de alto impacto en América Latina.
              </p>
            ...
            >
              <img
                ...
                alt="Fabio Canchila"
                className="rounded-2xl shadow-2xl w-full max-w-md mx-auto aspect-square object-cover transform hover:scale-105 transition-transform duration-300"
              />
            </motion.div>
          </div>
        </div>
